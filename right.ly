...
right = \absolute {
  ...
  \time 4/4
  \tempo "Cantabile" 1 = 36
  <b dis' fis' b'>2\fermata\) \tiny \tuplet 6/4 4 { \change Staff = "left" \stemUp cis16 gis cis' \change Staff = "right" b dis' b' \change Staff = "left" \clef "treble" \stemNeutral cis' gis' cis'' \change Staff = "right" b' dis'' b'' \change Staff = "left" |
  cis'' gis'' cis''' \change Staff = "right" b'' dis''' b''' \change Staff = "left" cis'''-"cross staff ottava" gis''' cis'''' \change Staff = "right" b''' dis'''' b'''' } \normalsize r4 <b b'>\( |
  <b cis' fis' b'>4. <a a'>8\) \tiny \tuplet 6/4 4 { \change Staff = "left" \stemUp a,16 e a \change Staff = "right" fis cis' fis' \change Staff = "left" \clef "treble" \stemNeutral a e' a' \change Staff = "right" fis' cis'' fis'' \change Staff = "left" |
  a' e'' a'' \change Staff = "right" fis'' cis''' fis''' \change Staff = "left" a''-"cross staff ottava" e''' a''' \change Staff = "right" fis''' cis'''' fis'''' } \normalsize r4 q4\( |
  <gis cis' e' gis'>4. <fis fis'>8\) \tiny \tuplet 6/4 4 { \change Staff = "left" \stemUp fis,16 cis fis \change Staff = "right" e cis' e' \change Staff = "left" fis cis' fis' \change Staff = "right" e' cis'' e'' \change Staff = "left" |
  ...
  <f a cis' f'>4. <ees ees'>8\) \tiny \tuplet 6/4 4 { \change Staff = "left" \stemUp ees,16 a, ees \change Staff = "right" eis a ees' \change Staff = "left" ees a ees' \change Staff = "right" eis' a' ees'' \change Staff = "left" |
